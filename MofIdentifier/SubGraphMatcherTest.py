...
class SubGraphMatcherTest(unittest.TestCase):
    ...
    def test_ligand_in_mof(self):
        ...
        self.assertEqual(True, find_ligand_in_mof(benzene, mof_808), "Benzene(6C) should be in mof")
        self.assertEqual(False, find_ligand_in_mof(solitary_benzene, mof_808), "Filled Benzene(6C, 6H) "
    ...
    def test_M6_node_in_various(self):
        ...
        self.assertEqual(True, find_ligand_in_mof(m6, ja500330a_si_006_auto), "Should find match in structures")
        self.assertEqual(True, find_ligand_in_mof(m6, ja500330a_si_007_auto), "Should find match in structures")
