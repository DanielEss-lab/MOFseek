...
from MofIdentifier import StrongSubGraphMatcher, WeakSubGraphMatcher, SubGraphMatcher
...
class StrongFindLigandInMofTest(unittest.TestCase):
    ...
    def test_single_atom(self):
        ...
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(carbon, carbon), "Carbon should be subgraph of Carbon")
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(iron, iron), "Iron should be subgraph of Iron")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(carbon, iron), "Carbon should not be subgraph of Iron")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(iron, carbon), "Iron should not be subgraph of Carbon")

    def test_atom_in_ligand(self):
        carbon = XyzReader.get_molecule('ligands/SingleCarbon.xyz')
        iron = XyzReader.get_molecule('ligands/SingleIron.xyz')
        benzene = XyzReader.get_molecule('ligands/BenzeneBase.xyz')
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(carbon, benzene), "Carbon should be subgraph of Benzene")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(iron, benzene), "Iron should not be subgraph of Benzene")

    def test_ligand_in_ligand(self):
        benzene = XyzReader.get_molecule('ligands/BenzeneBase.xyz')
        solitary_benzene = XyzReader.get_molecule('ligands/Benzene.xyz')
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(benzene, solitary_benzene), "Benzene(6C) should be "
                                                                              "subgraph of Benzene(6C, 6H")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(solitary_benzene, benzene), "Not other way around")

    def test_ligand_in_mof(self):
        benzene = XyzReader.get_molecule('ligands/BenzeneBase.xyz')
        solitary_benzene = XyzReader.get_molecule('ligands/Benzene.xyz')
        mof_808 = CifReader.get_mof('mofsForTests/smod7-pos-1.cif')
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(benzene, mof_808), "Benzene(6C) should be in mof")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(solitary_benzene, mof_808), "Filled Benzene(6C, 6H) "
    ...
    def test_requires_single_ligand(self):
        ...
        with self.assertRaises(Exception):
            StrongSubGraphMatcher.find_ligand_in_mof(six_carbon, benzene)
    ...
    def test_asterisk_WCA(self):
        ...
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(H2O_1, H20_good_ex), "Should find match in structures")
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(H2O_2, H20_good_ex), "Should find match in structures")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(H2O_1, H20_bad_ex), "Should not find match in structures")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(H2O_2, H20_bad_ex), "Should not find match in structures")
    ...
    def test_percent_sign_WCA(self):
        ...
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(m6, m6_fe), "Should find match in structures")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(m6, m6_bad), "Should not find match in structures")
    ...
    def test_pound_sign_WCA(self):
        ...
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(CO2_1, CO2_1_good_ex), "Should find match in structures")
        self.assertEqual(False, StrongSubGraphMatcher.find_ligand_in_mof(CO2_1, CO2_1_bad_ex), "Should not find match in structures")
    ...
    def test_M6_node_in_various(self):
        ...
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(m6, ja500330a_si_006_auto), "Should find match in structures")
        self.assertEqual(True, StrongSubGraphMatcher.find_ligand_in_mof(m6, ja500330a_si_007_auto), "Should find match in structures")
...
class WeakSubGraphMatcherTest(unittest.TestCase):
    ...
    def test_smiles_ligand_in_cif_mof(self):
        smiles_benzene = SmilesReader.mol_from_str('C1CCCCC1')
