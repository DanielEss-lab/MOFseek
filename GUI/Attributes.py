...
attributes = {
    ...
    "LCD": Attribute("Unknown acronym", lambda mof: round(mof.LCD, 3) if mof.LCD is not None else None, True, float),
    "PLD": Attribute("Unknown acronym", lambda mof: round(mof.PLD, 3) if mof.PLD is not None else None, True, float),
    "LFPD": Attribute("Unknown acronym", lambda mof: round(mof.LFPD, 3) if mof.LFPD is not None else None, True, float),
    "cm3_g": Attribute("Unknown acronym", lambda mof: round(mof.cm3_g, 3) if mof.cm3_g is not None else None, True, float),
    "ASA_m2_cm3": Attribute("Unknown acronym", lambda mof: round(mof.ASA_m2_cm3, 3) if mof.ASA_m2_cm3 is not None else None, False, float),
    "ASA_m2_g": Attribute("Unknown acronym", lambda mof: round(mof.ASA_m2_g, 3) if mof.ASA_m2_g is not None else None, False, float),
    "NASA_m2_cm3": Attribute("Unknown acronym", lambda mof: round(mof.NASA_m2_cm3, 3) if mof.NASA_m2_cm3 is not None else None, False, float),
    "NASA_m2_g": Attribute("Unknown acronym", lambda mof: round(mof.NASA_m2_g, 3) if mof.NASA_m2_g is not None else None, False, float),
    "AV_VF": Attribute("Unknown acronym", lambda mof: round(mof.AV_VF, 3) if mof.AV_VF is not None else None, False, float),
    "AV_cm3_g": Attribute("Unknown acronym", lambda mof: round(mof.AV_cm3_g, 3) if mof.AV_cm3_g is not None else None, False, float),
    "NAV_cm3_g": Attribute("Unknown acronym", lambda mof: round(mof.NAV_cm3_g, 7) if mof.NAV_cm3_g is not None else None, False, float),
    "Has_OMS": Attribute("Unknown acronym", lambda mof: mof.Has_OMS, False, bool),  # Boolean
